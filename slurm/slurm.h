...
typedef struct {
	...
	uint32_t max_batch_requeue; /* maximum number of launch-failure requeues */
	uint32_t max_node_fail_requeue; /* maximum number of node-failure requeues */
	uint32_t max_preempt_requeue; /* maximum number of preemption requeues */
