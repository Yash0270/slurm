...
static const parser_t PARSER_ARRAY(SLURM_CONF)[] = {
	...
	add_parse(UINT32, max_node_fail_requeue, "MaxNodeFailRequeue", "Max node-failure requeues before hold (0=unlimited)"),
	add_parse(UINT32, max_preempt_requeue, "MaxPreemptRequeue", "Max preemption requeues before hold (0=unlimited)"),
